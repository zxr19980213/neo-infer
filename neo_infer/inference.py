...
class InferenceEngine:
    ...
    def run_once(self, limit_rules: int = 100) -> InferenceRunSummary:
        results: list[ApplyRuleResult] = []
        total_conflicts = 0
        ...
        for rule in adopted_rules:
            ...
            conflicts = self.query_repo.count_rule_conflicts(rule)
    ...
    def run_fixpoint(
        ...
        for iteration in range(1, max_iterations + 1):
            ...
            for rule in adopted_rules:
                ...
                total_conflicts += self.query_repo.count_rule_conflicts(rule)
                if created > 0:
